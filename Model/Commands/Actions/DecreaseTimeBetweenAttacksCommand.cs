...
{
    public class DecreaseTimeBetweenAttacksCommand : UndoableCommand<float>
    {
        private readonly int _percents;
        private IVisualEffectService _effectService;

        public DecreaseTimeBetweenAttacksCommand(int percents, IVisualEffectService effectService)
        {
        ...
        protected override float PerformInternal(IMinion minion)
        {
            ...
            return minion.DecreaseTimeBetweenAttacks(value);
        }

        protected override void UndoInternal(IMinion minion, float value)
        {
            minion.IncreaseTimeBetweenAttacks(value);
        }
    }
}